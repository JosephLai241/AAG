...
### Dictionary of all fonts available
...
### Print a list of all the fonts available
def print_fonts():
...
### Input text to convert to ASCII and make art
...
def main():
    ...
    while True:
        try:
            option = str(input("\nJust list font names, see all 425 examples, or skip? [L/E/Y or N]: ")).upper()
            if option == "L":
                print_fonts()
            elif option == "E":
                examples()
